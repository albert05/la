		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					{!! Form::model(null, ['route' => [config('laraadmin.adminRoute') . '.captchas.store'], 'method'=>'POST', 'id' => 'captcha-edit-form']) !!}
					<img src="{{asset('la-assets/img/captcha/captcha.png')}}">
					<div class="form-group"><label for="code">Enter Code* :</label><div class='input-group'> <input class="form-control" placeholder="Enter Code" required="1" name="code" type="text" value=""></div>
						<br>
