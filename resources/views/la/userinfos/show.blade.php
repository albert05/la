		...
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="row stats">
						<div class="col-md-6 stat"><div class="label2" data-toggle="tooltip" data-placement="top" title="User Key">{{ $userinfo->user_key }}</div></div>
						<div class="col-md-6 stat"><i class="fa fa-map-marker"></i> {{ $userinfo->user_name }}</div>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="dats1"><i class="fa fa-envelope-o"></i> {{ $userinfo->password }}</div>
			<div class="dats1"><i class="fa fa-phone"></i> {{ $userinfo->pay_passwd }}</div>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'user_key')
						@la_display($module, 'user_name')
						@la_display($module, 'password')
						@la_display($module, 'pay_passwd')
					</div>
				</div>
			</div>
		</div>
